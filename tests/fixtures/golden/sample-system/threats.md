...
| --- | --- | --- | --- |
| `threat:entrypoint-denial-of-service:edge-actor-mermaid-client-component-mermaid-gateway-mermaid` | Denial of Service | Denial of service risk on Payments Gateway | high |
...
| `threat:entrypoint-elevation-of-privilege:edge-actor-mermaid-client-component-mermaid-gateway-mermaid` | Elevation of Privilege | Authorization bypass risk on Payments Gateway | high |
...
| `threat:entrypoint-information-disclosure:edge-actor-mermaid-client-component-mermaid-gateway-mermaid` | Information Disclosure | Information disclosure risk on Payments Gateway | medium |
...
| `threat:entrypoint-repudiation:edge-actor-mermaid-client-component-mermaid-gateway-mermaid` | Repudiation | Repudiation risk for Payments Gateway | high |
...
| `threat:entrypoint-spoofing:edge-actor-mermaid-client-component-mermaid-gateway-mermaid` | Spoofing | Spoofing risk from Web Client to Payments Gateway | high |
...
| `threat:entrypoint-tampering:edge-actor-mermaid-client-component-mermaid-gateway-mermaid` | Tampering | Request tampering risk on Payments Gateway | high |
...
- ID: `threat:entrypoint-denial-of-service:edge-actor-mermaid-client-component-mermaid-gateway-mermaid`
...
- ID: `threat:entrypoint-elevation-of-privilege:edge-actor-mermaid-client-component-mermaid-gateway-mermaid`
...
- ID: `threat:entrypoint-information-disclosure:edge-actor-mermaid-client-component-mermaid-gateway-mermaid`
...
- ID: `threat:entrypoint-repudiation:edge-actor-mermaid-client-component-mermaid-gateway-mermaid`
...
- ID: `threat:entrypoint-spoofing:edge-actor-mermaid-client-component-mermaid-gateway-mermaid`
...
- ID: `threat:entrypoint-tampering:edge-actor-mermaid-client-component-mermaid-gateway-mermaid`
